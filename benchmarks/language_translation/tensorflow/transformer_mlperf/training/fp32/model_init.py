...
class ModelInitializer(BaseModelInitializer):
    ...
    def __init__(self, args, custom_args, platform_util=None):
        ...
        run_script = os.path.join(self.args.intelai_models, self.args.mode, "fp32/transformer/transformer_main.py")
        ...
        parser.add_argument("--learning_rate", "-lr", type=int, default="2",
                            help="[default: %(default)s]  set learning rate 2 or can be set", metavar="<LR>")
        parser.add_argument("--static_batch", "-sb", type=str, default="No",
                            help="[default: %(default)s]  set, to not using static batch ", metavar="<SB>")

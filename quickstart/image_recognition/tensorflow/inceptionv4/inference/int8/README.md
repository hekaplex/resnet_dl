...
[inceptionv4-int8-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_3_0/inceptionv4-int8-inference.tar.gz)
...
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_3_0/inceptionv4-int8-inference.tar.gz
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.4.0-inceptionv4-int8-inference \

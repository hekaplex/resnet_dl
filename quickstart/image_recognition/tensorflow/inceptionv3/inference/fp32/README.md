...
[inceptionv3-fp32-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_3_0/inceptionv3-fp32-inference.tar.gz)
...
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_3_0/inceptionv3-fp32-inference.tar.gz
...
Inception V3 FP32 inference. To run one of the quickstart scripts 
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.4.0-inceptionv3-fp32-inference \

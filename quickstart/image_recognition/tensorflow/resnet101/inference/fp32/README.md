...
[resnet101-fp32-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_3_0/resnet101-fp32-inference.tar.gz)
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.4.0-resnet101-fp32-inference \
